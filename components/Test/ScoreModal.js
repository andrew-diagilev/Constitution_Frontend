    ...
    return (<Modal animationType="slide" transparent={true} visible={isTestPassed}>
        <View style={{flex: 1, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center'}}>
            <View style={{backgroundColor: COLORS.white, width: '90%', borderRadius: 20, padding: 20, alignItems: 'center'}}>
                <Text style={{fontSize: 30, fontWeight: 'bold'}}>{score > (totalQuestions / 2) ? 'Ви пройшли тест з результатом:' : 'Ваш результат міг би бути кращим!'}</Text>
                ...
                <TouchableOpacity onPress={handleNavigate} style={{backgroundColor: COLORS.accent, padding: 20, width: '100%', borderRadius: 20}}>
